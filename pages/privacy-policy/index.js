...
const PrivacyPolicy = () => {
  return (
    <Container>
      ...
      <Date>Last updated: January 01, 2022</Date>
      <Description>
      ...
      <ListBox>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to WebL Innovations, Sheikh Kamal IT
            Incubation Center, Khulna.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Webl Innovations, accessible from{" "}
            <a
              href="https://www.weblinnovations.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.weblinnovations.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ListBox>
        <li>
          <p>By email: weblinnovations.team@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:
            <a
              href="https://www.weblinnovations.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.weblinnovations.com/contact
            </a>
          </p>
        </li>
        <li>
          <p>By phone number: +8801749035147</p>
        </li>
      </ListBox>
    </Container>
  );
