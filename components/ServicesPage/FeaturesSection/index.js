...
const FeaturesSection = () => {
    ...
    return (
        <GenericWrapper>
            ...
            <SubTitle>Whether you have 15 minutes of content or 100 volumes, we can scale to any size project easily.</SubTitle>
            
           
                <Row>
                    <Col md={4}>
                        {
                            sectionOne.map(feature => <FeatureBox icon={feature.icon} title={feature.title} description={feature.text} />)
                        }
                    </Col>
                    <Col mdOffset={1} md={2}><VerticalSeparator centered={true} bgColor="#3CBB95" height="100%"/></Col>
                    <Col mdOffset={1} md={4}>
                         {
                            sectionTwo.map(feature => <FeatureBox icon={feature.icon} title={feature.title} description={feature.text} />)
                        }
                    </Col>
                </Row>
